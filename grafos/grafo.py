...
class Arista(Generic[T]):
    def __init__(self, origen: T , destino: T, valor: int = 1, direccionada: bool = False) -> None:
...
if __name__ == "__main__":
    ...
    grafo.agregar_arista(12,13)
    grafo.agregar_arista(13,11)
